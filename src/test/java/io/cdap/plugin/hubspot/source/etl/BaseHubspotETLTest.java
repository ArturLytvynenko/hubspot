...
public abstract class BaseHubspotETLTest extends HydratorTestBase {
  ...
  protected List<StructuredRecord> getPipelineResults(Map<String, String> sourceProperties,
    ...
    return getTestRunner().getPipelineResults(sourceProperties, expectedRecordsCount);
  }

  public interface TestsRunner {
    List<StructuredRecord> getPipelineResults(Map<String, String> sourceProperties,
                                                     int expectedRecordsCount) throws Exception;
  }
  ...
  public class BatchTestRunner implements TestsRunner {
    ...
    @Override
    public List<StructuredRecord> getPipelineResults(Map<String, String> sourceProperties,
                                                        int expectedRecordsCount) throws Exception {
